...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('support', url='https://t.me/mc_movie_update_2022'),
                InlineKeyboardButton('channel', url='https://t.me/new_all_movies_club')
            ],
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/+gahY7Z7Iml03OTBl')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('movie club', url='https://t.me/+gahY7Z7Iml03OTBl')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/+gahY7Z7Iml03OTBl")]
        )
    else:
        btn.append(
